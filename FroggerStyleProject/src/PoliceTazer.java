...
public class PoliceTazer{
	...
	public PoliceTazer() {
		...
		forward 	= getImage("/imgs/"+"PoliceTazer2.png"); //load the image for Tree
	...
	public PoliceTazer(int x, int y) {
...
*/
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = PoliceTazer.class.getResource(path);
