...
public class ChipScrolling2{
	...
	double scaleWidth = .13;		//change to scale image
	double scaleHeight = .1; 		//change to scale image

	public ChipScrolling2() {
		//load the main image(front or forward view)
		forward 	= getImage("/imgs/"+"log2.png"); //load the image for Tree
	...
	public ChipScrolling2(int x, int y) {
...
*/
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = ChipScrolling2.class.getResource(path);
