...
public class PoliceScrolling{
	...
	public PoliceScrolling() {
		//load the main image(front or forward view)
		forward 	= getImage("/imgs/"+"Police Car.png"); //load the image for Tree
	...
	public PoliceScrolling(int x, int y) {
	...
	*/
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = PoliceScrolling.class.getResource(path);
